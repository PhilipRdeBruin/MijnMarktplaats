...
<?php
    ...
    // Check file size
    if ($_FILES["file_to_upload"]["size"] > 1000*2048) {
...
//            echo "<p id='hidden_uploadbestand'>$target_file<p>";
//            echo "<script>plaats_foto_insert();</script>";
            phpalert("The file $uploadbestand has been uploaded.");
